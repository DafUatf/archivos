...
{!! Form::model($pres, ['route' => ['prestamo.update', $pres->id], 'class '=> 'form', 'method' => 'put']) !!}
	...
	<div class="form-group">
		...
		{!! Form::text('fecha_prestamo', null, ['class'=>'form-control', 'required'=>'true', 'placeholder' => 'aaaa-mm-dd', 'readonly']) !!}
	</div>
	<div class="form-group">
		{{ Form::label('unidad', 'Unidad Solicitante (*)', ['class' => 'control-label', 'required'=>'true']) }}
		{!! Form::text('unidad', null, ['class'=>'form-control', 'placeholder' => 'Ingrese la unidad que Solicita el Prestamo', 'required'=>'true', 'readonly']) !!}
	</div>
	<div class="form-group">
		{{ Form::label('persona_dip', 'Documento de Identificacion Personal(Dip) (*)', ['class' => 'control-label', 'required'=>'true']) }}
		{!! Form::text('persona_dip', null, ['class'=>'form-control', 'placeholder' => 'registro personal', 'required'=>'true', 'readonly']) !!}
	</div>
	<div class="form-group">
		{{ Form::label('comprobante_cod_archivo', 'Codigo de Archivo (*)', ['class' => 'control-label', 'required'=>'true']) }}
		{!!Form::text('comprobante_cod_archivo', null, ['class'=>'form-control', 'placeholder' => 'codigo del archivo', 'required'=>'true', 'autocomplete', 'readonly'])!!}
	</div>
	<div class="form-group">
